...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    #[ORM\OneToMany(mappedBy: 'ownedBy', targetEntity: ApiTokens::class)]
    ...
    public function addApiToken(ApiTokens $apiToken): self
    {
    ...
    public function removeApiToken(ApiTokens $apiToken): self
    {
    ...
    public function getValidTokenStrings(): array
    {
        return $this->getApiTokens()
            ->filter(fn (ApiTokens $token) => $token->isValid())
            ->map(fn (ApiTokens $token) => $token->getToken())
            ->toArray();
    }
    ...
    public function setPlainPasswor(string $plainPassword): User
    {
